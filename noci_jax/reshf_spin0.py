...
def optimize_res(h1e, h2e, mo_coeff, nocc, nvecs=None, init_tvecs=None, 
    ...
    rot_hf = slater_jax_spin0.gen_rmat_hf(nvir, nocc)
    E0 = slater_jax_spin0.noci_energy(rot_hf, mo_coeff, h1e, h2e, return_mats=False)

    def cost_func(t):
        tvecs = t.reshape(nvecs, -1)
        rmats = slater_jax_spin0.tvecs_to_rmats(tvecs, nvir, nocc)
        rmats = jnp.vstack([rot_hf, rmats])
        e = slater_jax_spin0.noci_energy(rmats, mo_coeff, h1e, h2e, return_mats=False)
        return e
