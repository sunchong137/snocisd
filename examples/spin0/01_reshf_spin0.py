...
niter = 8000
print_step = 1000
# t0 = thouless_spin0.gen_thouless_singles(nocc, nvir, max_nt=n_dets, zmax=2, zmin=0.1)[:n_dets]
t0 = thouless_spin0.gen_init_singles(nocc, nvir, max_nt=n_dets, zmax=2, zmin=0.1)

# t0 = thouless_spin0.gen_thouless_doubles(nocc, nvir, max_nt=n_dets, zmax=2, zmin=0.1)[:n_dets]
# noise = thouless_spin0.gen_thouless_random(nocc, nvir, max_nt=n_dets)[:n_dets]
# # t0 = noise
