...
t0 = noci.gen_thouless_singles(nocc, nvir, max_nt=nr, zmax=5, zmin=0.2)[:n_dets]
nvecs = len(t0)
...
er, vecs = rbm.rbm_all(h1e, h2e, mo_coeff, nocc, nvecs, init_rbms=t0, ao_ovlp=ao_ovlp, tol=ftol, MaxIter=niter, disp=True)
e_rbm = er + e_nuc
