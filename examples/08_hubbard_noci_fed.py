...
import sys
sys.path.append("../")
import molecules, noci, rbm, optdets
...
init_guess[0][0,0] = 2
init_guess[1][0,0] = 0
# np.fill_diagonal(init_guess[0], 2)
...
E, rn = optdets.optimize_fed(t0, mo_coeff, h1e, h2e, ao_ovlp=ao_ovlp, tol=ftol, MaxIter=niter, nsweep=nsweep)
e_noci = E + e_nuc
