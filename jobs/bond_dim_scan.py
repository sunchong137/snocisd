...
def scan_bd_hub(U, e_tol=1e-5):
    ...
    with open(res_dir + "/hubbard1d_scan_U{}.txt".format(U), "w") as fin:
        fin.write("DMRG for 1D Hubbard model, U = {}\n".format(U))
        ...
        for n in nsites:
            ...
            for bd in bdims:
                E = hubbard_dmrg.hubbard1d_dmrg(n, U, (ne_a, ne_a), pbc=True, init_bdim=20, 
                                                max_bdim=bd, nsweeps=10)
                E /= n
                if abs(E - E0) < e_tol:
